...
import com.retos.model.Order;
import com.retos.services.OrderServices;
...
public class OrderController {
    ...
    @PutMapping("/add/{id}")
    @ResponseStatus(HttpStatus.CREATED)
    public Order addProduct(@PathVariable("id") Integer idOrder, @RequestBody Optional<Clothe> clone) {
